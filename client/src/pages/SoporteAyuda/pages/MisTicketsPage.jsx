  ...
  return (
    <div>
      <div className="mb-6 flex flex-col md:flex-row md:justify-between md:items-center">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Mis Tickets de Soporte</h1>
          <p className="text-gray-600">Gestiona y consulta el estado de tus solicitudes de soporte</p>
        </div>
                ...
                <CardHeader>
                  <div className="flex items-start justify-between">
                    <div className="flex-1 min-w-0">
                      ...
                      <h3 
                        className="font-medium text-gray-900 text-sm leading-5 mb-1"
                        style={{
                          display: '-webkit-box',
                          WebkitLineClamp: 2,
